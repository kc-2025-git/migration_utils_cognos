WITH expected_objects AS (
    SELECT 'BANINST1' AS expected_owner, 'AP_DEDUCTIONS_BENEFITS' AS expected_object FROM dual
    UNION ALL SELECT 'BANINST1', 'AP_EMPLOYEE_PROFILE' FROM dual
    UNION ALL SELECT 'BANINST1', 'AP_EMPLOYMENT_VERIFICATION' FROM dual
    UNION ALL SELECT 'BANINST1', 'AP_EMPLOY_RECRUITMENT_ACTIVITY' FROM dual
    UNION ALL SELECT 'BANINST1', 'AP_JOB_SUMMARY' FROM dual
    UNION ALL SELECT 'BANINST1', 'AP_SALARY_BUDGET' FROM dual
    UNION ALL SELECT 'BANINST1', 'WGVEDUC' FROM dual
